...
@Import({HttpMediaTypeNotAcceptableIntegrationTest.TestController.class})
@AutoConfigureMockMvc
class HttpMediaTypeNotAcceptableIntegrationTest {

  @RestController
  static class TestController {

    @GetMapping(path = "/endpoint", produces = MediaType.TEXT_PLAIN_VALUE)
    String endpoint() {
      return "OK";
    }
  }
