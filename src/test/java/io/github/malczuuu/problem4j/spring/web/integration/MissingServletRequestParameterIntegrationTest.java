...
@Import({MissingServletRequestParameterIntegrationTest.TestController.class})
@AutoConfigureMockMvc
class MissingServletRequestParameterIntegrationTest {

  @RestController
  static class TestController {
    @GetMapping("/endpoint")
    String endpoint(@RequestParam("name") String name) {
      return "OK";
    }
  }
