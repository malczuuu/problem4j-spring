...
@Import({ConversionNotSupportedIntegrationTest.TestController.class})
@AutoConfigureMockMvc
class ConversionNotSupportedIntegrationTest {
  ...
  static class TestController {
    @GetMapping("/endpoint")
    String endpoint(@RequestParam("value") CustomType value) {
      return "OK";
    }
  }
  ...
  void givenException_shouldOverrideIt() throws Exception {
    mockMvc
        .perform(get("/endpoint").param("value", "type"))
