 ...
 *   <li>{@link #map(Exception, HttpHeaders, HttpStatusCode, WebRequest)} – produces the {@link
 *       Problem} response for the given exception.
 * </ul>
 */
public interface ExceptionMapping {
  ...
  Problem map(Exception ex, HttpHeaders headers, HttpStatusCode status, WebRequest request);
}
