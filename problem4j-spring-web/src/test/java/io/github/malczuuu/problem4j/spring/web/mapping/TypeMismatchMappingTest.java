...
class TypeMismatchMappingTest {

  private TypeMismatchMapping typeMismatchMapping;

  @BeforeEach
  void beforeEach() {
    typeMismatchMapping = new TypeMismatchMapping(new IdentityProblemFormat());
  }
  ...
  void givenExceptionWithParameterNameAndType_shouldReturnProblemWithAll() {
    ...
    Problem problem = typeMismatchMapping.map(ex, new HttpHeaders(), HttpStatusCode.valueOf(400));
