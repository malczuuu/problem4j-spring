...
/**
 * Processor that converts a {@link Throwable} annotated with {@link ProblemMapping} into a {@link
 * Problem} according to RFC 7807 (Problem Details for HTTP APIs).
 *
 * <p>This processor supports dynamic interpolation of placeholders in the annotation values. The
 ...
 *             </ul>
 *       </ol>
 *   <li>Build and return the {@link Problem}.
 *   <li>If any unexpected runtime exception occurs during processing, wrap it in {@link
 ...
 * @see ProblemMapping
 */
public class SimpleProblemMappingProcessor implements ProblemMappingProcessor {
   ...
   */
  @Override
  public Problem toProblem(Throwable t, ProblemContext context) {
    if (t == null) {
      return null;
    }
    ...
    try {
      ...
      throw new ProblemProcessingException("Unexpected failure while processing ProblemMapping", e);
    }
  }
