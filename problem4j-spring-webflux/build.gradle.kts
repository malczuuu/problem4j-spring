...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name = "[Deprecated] Problem4J Spring WebFlux"
                description =
                    "[Deprecated] Spring WebFlux integration for library implementing RFC7807. Migrated to io.github.problem4j:problem4j-spring-webflux namespace."
