...
@Import({
  ValidateMethodArgumentFailingWithAdaptionMvcIntegrationTest.ValidateParameterController.class
})
class ValidateMethodArgumentFailingWithAdaptionMvcIntegrationTest {
