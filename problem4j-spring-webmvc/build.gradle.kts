...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name = "[Deprecated] Problem4J Spring WebMVC"
                description =
                    "[Deprecated] Spring WebMVC integration for library implementing RFC7807. Migrated to io.github.problem4j:problem4j-spring-webmvc namespace."
